...
Please be sure your laptop is properly configured before the workshop by following the [installation and setup instructions](https://github.com/NASA-NAVO/notebooks/blob/main/00_SETUP.md)
